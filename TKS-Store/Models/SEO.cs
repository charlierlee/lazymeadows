...
namespace TKS.Models {
	public class SEO {
		...
		public string GetTags(string URL, string DefaultTitle = "", string DefaultDescription = "") {
			...
			//Other tags
			if (!string.IsNullOrEmpty(TKS.Areas.Admin.Models.Global.RSSFeedURL) && TKS.Areas.Admin.Models.Global.RSSFeedURL != TKS.Areas.Admin.Models.Global.BaseURL) {
			...
			if (!string.IsNullOrEmpty(TKS.Areas.Admin.Models.Global.SiteName) || !string.IsNullOrEmpty(TKS.Areas.Admin.Models.Global.SiteNameAlternate)) {
				if (!string.IsNullOrEmpty(TKS.Areas.Admin.Models.Global.SiteName) && !string.IsNullOrEmpty(TKS.Areas.Admin.Models.Global.SiteNameAlternate)) {
					sb.AppendLine("<script type='application/ld+json'>" +
									"{  \"@context\" : \"http://schema.org\", " +
									   "\"@type\" : \"WebSite\", " +
									   "\"name\" : \"" + TKS.Areas.Admin.Models.Global.SiteName + "\", " +
									   "\"alternateName\" : \"" + TKS.Areas.Admin.Models.Global.SiteNameAlternate + "\", " +
									   "\"url\" : \"" + TKS.Areas.Admin.Models.Global.BaseURL + "\" }</script>");
				}
			}
